...
<div class="section-head">
  ...
  <a class="all-pubs-link" href="{{ '/publications/' | relative_url }}">All Publications &raquo;</a>
</div>

<table style="border-collapse:collapse; border:none; width:100%;">
{% for p in site.data.publications.papers %}{% if p.selected %}{% include pub-entry.html paper=p %}{% endif %}{% endfor %}
</table>
...
<table style="border-collapse:collapse; border:none; width:100%;">
  <tr style="border:none;">
    <td style="width:180px; vertical-align:top; border:none; padding:8px;">
      <img src="/assets/imgs/Meta-Logo.png" class="work-logo" height="84">
    </td>
  ...
  <tr style="border:none;">
    <td style="width:180px; vertical-align:top; border:none; padding:8px;">
      <img src="/assets/imgs/apple_logo.jpeg" class="work-logo" height="84">
    </td>
    <td style="vertical-align:top; border:none; padding-left:16px; width:50%;">
  ...
  <tr style="border:none;">
    <td style="width:180px; vertical-align:top; border:none; padding:8px 0;">
      <img src="/assets/imgs/samsung_logo.png" class="work-logo" height="84">
    </td>
    <td style="vertical-align:top; border:none; padding-left:16px; width:50%;">
  ...
  <tr style="border:none;">
    <td style="width:180px; vertical-align:top; border:none; padding:8px 0;">
      <img src="/assets/imgs/naver_logo.png" class="work-logo" height="84">
    </td>
    <td style="vertical-align:top; border:none; padding-left:16px; width:50%;">
  ...
  <tr style="border:none;">
    <td style="width:180px; vertical-align:top; border:none; padding:8px 0;">
      <img src="/assets/imgs/kaist_logo.png" class="work-logo" height="84">
    </td>
    <td style="vertical-align:top; border:none; padding-left:16px; width:50%;">
  ...
  <tr style="border:none;">
    <td style="width:180px; vertical-align:top; border:none; padding:8px 0;">
      <img src="/assets/imgs/h2k_logo.png" class="work-logo" height="84">
    </td>
    <td style="vertical-align:top; border:none; padding-left:16px; width:50%;">
